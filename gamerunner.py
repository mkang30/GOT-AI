...
def run_game(asp, bots, visualizer=None, delay=.2, max_wait=1, max_rounds=200, colored=True):
    """
    Inputs:
...
def run_game_training(asp, bots, visualizer=None, delay=0.2, max_wait=None, max_rounds=200, colored=True):
    """
    Inputs:
        - asp: an adversarial search problem
        - bots: a list in which the i'th element is the bot for player i
